...
def criar():
    if request.method == 'POST':
        ...
        # Adicionar na bd
        user = User(name=nome, role="Cliente", email=email, tel=tele, pais=pais, leads=leads,
...
@roles('Admin')
def lista():
    return render_template("cliente/lista.html", cliente=User.query.filter_by(role='Cliente'))
